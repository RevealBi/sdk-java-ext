...
public interface IAuthorizationProvider extends IRVDashboardAuthorizationProvider {
	...
	default boolean hasDashboardsPermission(String userId, DashboardsActionType action) {
		throw new RuntimeException("Please implement hasDashboardsPermission(IRVUserContext userContext, DashboardsActionType action)");
	}
	...
	default boolean hasDashboardPermission(String userId, String dashboardId, DashboardActionType action) {
		throw new RuntimeException("Please implement hasDashboardPermission(IRVUserContext userContext, String dashboardId, DashboardActionType action)");
	}
}
